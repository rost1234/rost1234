...
- **Focus sounds**: seamless loops generated by `scripts/generate_focus_sounds.py` (white/pink/brown noise, 40 Hz binaural
  over pink noise), played with `expo-audio` in the background; each option shows an honest one-line evidence note.
